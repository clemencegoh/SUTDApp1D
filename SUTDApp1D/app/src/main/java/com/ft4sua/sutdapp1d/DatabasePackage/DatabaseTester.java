...
public class DatabaseTester {
    ...
    public static void test(Context con){
        ...
        Event testet=new Event("Normal ducks", "Friday, 14 Dec 2017", "16:00",
                "18:00", "Pond", "1");
        EH.addEvent(testet,con);
        EH.getAllEventsList();


        testet=new Event("Quirky ducks", "Thursday, 13 Dec 2017", "16:00",
                "18:00", "MPH", "1");
        testet.setId(2);
        EH.editEvent(testet,con);
        EH.getAllEventsList();

        EH.deleteEvent(testet,con);
//        EH.getAllEventsList();
